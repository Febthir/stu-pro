<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column
                v-for="item in deptTableOptions"
                :key="item.prop"
                :label="item.label"
                :prop="item.prop"
                :width="item.width"
...
// 表头配置
import { deptTableOptions } from '../tableConfig'
...
export default {
    ...
    cruds() {
        return CRUD({ title: '部门', url: 'system/dept/getList', crudMethod: { ...crudDept } })
    },
    data() {
        return {
            deptTableOptions,
    ...
    methods: {
        ...
        getSupDepts(id) {
            crudDept.getSupDepts({ pid: id }).then(res => {
