<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column
                v-for="item in menuTableOptions"
                :key="item.prop"
                :label="item.label"
                :prop="item.prop"
                :width="item.width"
            ...
            >
                <template slot-scope="scope">
                    ...
                    <span v-else-if="item.prop == 'iframe'">
                        <span v-if="scope.row.iframe">是</span>
                        <span v-else>否</span>
                    </span>
                    <span v-else-if="item.prop == 'cache'">
...
// 表头配置
import { menuTableOptions } from '../tableConfig'
...
export default {
    ...
    cruds() {
        return CRUD({ title: '菜单', url: 'system/menus/getList', crudMethod: { ...crudMenu } })
    },
    data() {
        return {
            menuTableOptions,
    ...
    methods: {
        ...
        getSupMenus(id) {
            crudMenu.getSupMenus({ id }).then(res => {
                const children = res.data.content.map(function(obj) {
